...
public class ServicoMrrResource {
	...
	@Produces(MediaType.APPLICATION_JSON + ";charset=utf-8")
	public MetricaCidade[] getMetrica(NomeMesJson nomeMes) {
	...
	@Produces(MediaType.APPLICATION_JSON + ";charset=utf-8")
	public MetricaEstado[] getMetricaEstado(@PathParam("estado") String estado, @PathParam("mes") int mes) {
	...
	@Produces(MediaType.APPLICATION_JSON + ";charset=utf-8")
	public MetricaSegmento[] getMetricaSegmento(NomeMesJson nomeMes) {
	...
	@Produces(MediaType.APPLICATION_JSON + ";charset=utf-8")
	public MetricaEmpresa[] getMetricasEmpresa( @PathParam("mes") int mes) {
